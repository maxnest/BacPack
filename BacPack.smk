...
btyper3_report = f"{OUTPUT_DIR}/{SPECIES_TAG}_btyper3/btyper3_final_results/{SPECIES_TAG}.selected_seqs_final_results.txt",
...
rule_all_results = [quast_report, selected_seqs_fastani, selected_seqs_vs_bacillales_odb10, selected_seqs_vs_bacilli_odb10, prokka_proteins, prokka_gff3, prokka_report, busco_bacillales_report, busco_bacilli_report, checkm_report, prokka_cryprocessor_log, cryprocessor_report, bttoxin_digger_report, deepbgc_report, antismash_gbk, mmseqs_vs_vfdb, mmseqs_vfdb_filtered, btyper3_report, pipeline_general_description, pipeline_toxins_description, pipeline_bgc_description]
