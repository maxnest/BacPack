...
def btyper3_txt_parsing(btyper3_txt, summary_dict):
    btyper3_pd = pd.read_csv(btyper3_txt, sep='\t')
    taxon = btyper3_pd['final_taxon_names']
    if 'Species unknown' in taxon.to_list()[0]:
        summary_dict['BTyper3: Taxon name'] = 'Species unknown'
    else:
        summary_dict['BTyper3: Taxon name'] = taxon.to_list()[0]
...
if __name__ == '__main__':
    summary_dict = {}
    # BTyper3 #
    btyper3_txt_parsing(snakemake.input.btyper3_report, summary_dict)
    # Quast #
